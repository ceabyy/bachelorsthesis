...
def main():
    ...
    quality_factor_list = [90]
    testset_name = 'DIV2K_train_HR_mini_compressed_90_gray' # 'LIVE1_gray' 'Classic5' 'BSDS500_gray'
    ...
    for quality_factor in quality_factor_list:
        ...
        set_start_time = time.time()  # START timing for the entire set

        for idx, img in enumerate(H_paths):
            img_start_time = time.time()  # START timing for this image
